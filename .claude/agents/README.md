...
- `auth-auditor.md` — Deep-dives Laravel auth code (Passport / Sanctum / JWT, OTP, password reset, the four signup endpoints) for security vulnerabilities; writes a report to `docs/audit-results/AUTH_SECURITY_REVIEW.md`
