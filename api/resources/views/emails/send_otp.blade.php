        ...
        <tr>
            <td align="center" style="padding: 20px;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px; background-color: #ffffff; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <h2 style="margin: 0 0 15px 0; font-size: 20px; color: #000000;">Confirm Your Identity with OTP</h2>
                            
                            <p style="margin: 0 0 20px 0; line-height: 1.5; color: #6c757d;">To verify your identity, use the code below:</p>
                            
                            <p style="display: inline-block; background-color: #dc3545; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 5px; margin-bottom: 20px; font-size: 20px; font-weight:bold;">{{$otp}}</p>
                            
                            <p style="margin: 0; font-size: 14px; color: #6c757d;">The code is valid for 10 minutes, until: {{$expiresAt}}</p>
                        </td>
                    </tr>
                </table>
            </td>
