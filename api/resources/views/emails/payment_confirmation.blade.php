...
<head>
    ...
    <title>{{ __('mail.payment.title') }}</title>
</head>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px; background-color: #ffffff; border-radius: 5px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                    <tr>
                        <td align="center" style="padding: 30px 20px;">
                            ...
                            <h2 style="margin: 0 0 15px 0; font-size: 20px; color: #000000;">{{ __('mail.payment.heading') }}</h2>
                            ...
                            <table border="0" cellpadding="10" cellspacing="0" width="100%" style="max-width: 400px; background-color: #f8f9fa; border-radius: 5px; margin-bottom: 20px;">
                                ...
                                <tr>
                                    <td align="left"><strong>{{ __('mail.payment.billing_period') }}:</strong> {{ ucfirst($billingCycle) }}</td>
                                </tr>
                                <tr>
                                    <td align="left"><strong>{{ __('mail.payment.amount_paid') }}:</strong> €{{ number_format($amount, 2) }}</td>
                                </tr>
                                <tr>
                                    <td align="left"><strong>{{ __('mail.payment.transaction_id') }}:</strong> {{ $captureId }}</td>
                                </tr>
                            </table>

                            <a href="{{ config('app.frontend_url') }}/client" style="display: inline-block; background-color: #301068; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 5px; margin-bottom: 20px;">{{ __('mail.payment.cta') }}</a>

                            <p style="margin: 0; font-size: 14px; color: #6c757d;">{{ __('mail.common.support') }}</p>
                        </td>
                    </tr>
                </table>
            </td>
