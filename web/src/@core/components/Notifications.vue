...
const clickNotification = async (notification) => {
  try {
    const response = await $api('https://api-ds.bitemybytes.com/api/v1/notifications/readUnread', {
      method: 'POST',
      body: {
        'id': notification.id,
        'type': 'read'
...
const assignAgentToClient = async (client_id, chat_id) => {
  try {
    const response = await $api('https://api-ds.bitemybytes.com/api/v1/chat/assignAgentToClient', {
      method: 'POST',
      body: {
        'client_id': client_id,
        'chat_id': chat_id
...
const fetchMessagesByChatIdAndClient = async (client_id, chat_id) => {
  try {
    const response = await $api('https://api-ds.bitemybytes.com/api/v1/chat/fetchMessagesByChatIdAndClient', {
      method: 'POST',
      body: {
        'client_id': client_id,
        'chat_id': chat_id,
...
const fetchNotifications = async () => {
  try {
      const response = await $api('https://api-ds.bitemybytes.com/api/v1/notifications/fetch', {
        method: 'POST',
        body: {},
        headers: {
          'Content-Type': 'application/json',
