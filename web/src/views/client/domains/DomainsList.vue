...
import DomainListFilters from './DomainListFilters.vue';
...
onMounted(()=>{
  ...
  console.log("XXXXXXXXXXXXXXXX",domainsDatas.value)
});
...
const domains = computed(() => domainsDatas.value)

console.log("from gent", domains);
// const totalClients = computed(() => domainsDatas.value.totalDomains)
              ...
              <VCardText class="clients__filters--text">
                  <VRow>
                    ...
                    <VBtn
                      variant="outlined"
                      color="secondary"
                      @click="(filterDomains) ? filterDomains = 0 : filterDomains = 1"
                    >
        ...
        <template #bottom>
          <VCardText class="pt-2">
            <div class="d-flex flex-wrap justify-center justify-sm-space-between gap-y-2 mt-2">
              ...
              {{ paginationMeta(options, totalDomains) }}
            </p>
              ...
              <VPagination
                ...
                :length="Math.ceil(totalDomains / perPage)"
