  ...
  actions: {
    fetchClients(queryParams) {
        return new Promise((resolve, reject) => {
            useApi(createUrl('/v1/client/fetchClients', queryParams))
    ...
    registerClientFromAdmin(formData) {
      return new Promise((resolve, reject) => {
        $api('/v1/admin/registerNewClient', {
          method: 'POST',
          body: formData,
        }).then(response => resolve(response))
        .catch(error => reject(error));
    ...
    fetchAgents(queryParams) {
      return new Promise((resolve, reject) => {
          useApi(createUrl('/v1/admin/fetchAgents', queryParams))
          .then(response => resolve(response))
          .catch(error => reject(error));
      });
    },
    ...
    deleteAgentFromAdmin(agentId) {
      return new Promise((resolve, reject) => {
        $api('/v1/admin/deleteAgent/'+agentId, {
          method: 'GET'
        }).then(response => resolve(response))
        .catch(error => reject(error));
      });
    ...
    fetchAdmins(queryParams) {
      return new Promise((resolve, reject) => {
          useApi(createUrl('/v1/admin/fetchAdmins', queryParams))
          .then(response => resolve(response))
          .catch(error => reject(error));
      });
    },
    ...
    deleteAdminFromAdmin(agentId) {
      return new Promise((resolve, reject) => {
        $api('/v1/admin/deleteAdmin/'+agentId, {
          method: 'GET'
        }).then(response => resolve(response))
        .catch(error => reject(error));
      });
