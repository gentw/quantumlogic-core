...
const fetchUsers = async (e) => {
  ...
  try {
    const res = await $api('https://api-ds.bitemybytes.com/api/v1/admin/notifReminders/findUserByName', {
      method: 'POST',
...
const storeNotificationReminder = async () => {
  const res = await $api('https://api-ds.bitemybytes.com/api/v1/admin/notifReminders/create', {
      method: 'POST',
      body: data.value,
      onResponseError({ response }) {
        // alert(1)
